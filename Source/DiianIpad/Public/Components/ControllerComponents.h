...
#include "ControllerComponents.generated.h"
 
UCLASS(Blueprintable, BlueprintType, HideCategories = (Trigger, PhysicsVolume))
class DIIANIPAD_API UControllerComponents : public UActorComponent
{
	GENERATED_BODY()

public: 
	UControllerComponents(const FObjectInitializer& ObjectInitializer);
